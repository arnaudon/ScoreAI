...
def upgrade() -> None:
    op.add_column('score', sa.Column('short_description_fr', sqlmodel.sql.sqltypes.AutoString(), nullable=False, server_default=''))
    op.add_column('score', sa.Column('long_description_fr', sqlmodel.sql.sqltypes.AutoString(), nullable=False, server_default=''))
